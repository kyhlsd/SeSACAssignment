...
struct ShoppingAPIManager {
    ...
    private func getURL(searchText: String, display: Int = 100, sortOption: SortOption = .accuracy) -> String {
    ...
    func fetchData(searchText: String, sortOption: SortOption = .accuracy, successHandler: @escaping (ShoppingResult) -> (), failureHandler: @escaping (AFError) -> ()) {
        let url = getURL(searchText: searchText, sortOption: sortOption)
